...
As a data analyst, I can create a feature that allows users to input the number N and retrieve a list of the top N populated countries in the world, facilitating focused analysis on the most populous nations.
### Scope
...
1. Data analyst requests report about top 5 populated countries in the world where 5 is provided by the user.
