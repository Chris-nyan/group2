# USE CASE: <18> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can generate a list of all capital cities in the continent ordered by population size, enabling analyses of the significance of capital cities on a continent.
### Scope
...
4. Get Output for all the capital cities in a continent by largest population to smallest
