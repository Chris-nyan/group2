# USE CASE: <7> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can organize the list of city in the world ordered by population size so that I can do demographic analysis.
### Scope
...
1. Data analyst requests report about all the cities in the world by largest population to smallest.
