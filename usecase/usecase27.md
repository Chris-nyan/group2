# USE CASE: <27> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I want to access and retrieve the current population of the continent so that I can conduct continent-specific demographic analyses.
### Scope
...
1. Data analyst requests report about population of a continent.
