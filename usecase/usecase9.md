# USE CASE: <9> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can organize and display cities within a specific region based on their population size so that it can do in-depth analyses of urban centers on the continent.
### Scope
...
1. Data analyst requests report about all the cities in a region by largest population to smallest.
