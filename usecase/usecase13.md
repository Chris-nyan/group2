# USE CASE: <13> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can create functionality that allows users to input the number N and retrieve a list of the top N populated cities in the continent so that it can dofacilitating analyses of major urban centers.
### Scope
...
1. Data analyst requests report about top 5 populated cities in a continent where 5 is provided by the user.
