# USE CASE: <8> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can organize and display cities within a specific continent based on their population size so that it can do in-depth analyses of urban centers on the continent.
### Scope
