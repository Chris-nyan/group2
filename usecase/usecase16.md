# USE CASE: <16> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can create functionality that allows users to input the number N and retrieve a list of the top N populated cities in the district so that it can dofacilitating analyses of major urban centers.
### Scope
...
1. Data analyst requests report about top 5 populated countries in a district where 5 is provided by the user.
