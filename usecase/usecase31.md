# USE CASE: <31> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I want to access and retrieve the current population of the city so that I can conduct demographic analyses of city.
### Scope
...
1. Data analyst requests report about population of a city.
