# USE CASE: <22> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can create features that allow users to input the number N and retrieve a list of the top N populated capital cities in the region so that it can do cultural significance of region cities.
### Scope
...
4. Get Output for top 5 populated capital cities in a region where 5 is provided by the user
