# USE CASE: <20> <Report Population Information>

## CHARACTERISTIC INFORMATION

### Goal in Context

As a data analyst, I can create features that allow users to input the number N and retrieve a list of the top N populated capital cities globally, facilitating analyses of urban governance and policy formulation.
...
1. Data analyst requests report about top 5 populated capital cities in the world where 5 is provided by the user.
